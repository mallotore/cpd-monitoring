    ...
    <td style="width: 25%">
        <table> 
            ...
            <tr>
                ...
                <td>
                    <label id="connectivityAlert_label_${server.id}" style="width: 100%;font-weight: normal;margin-left:10px">${server?.connectivityAlert ? 'Activada' : 'Desactivada'}</label>
                    <input id="connectivityAlert_text_${server.id}" type="checkbox" style="display:none; margin-left:10px" checked="${server?.connectivityAlert ? 'checked' : ''}">
                </td>
            </tr>
        </table>
    </td>
